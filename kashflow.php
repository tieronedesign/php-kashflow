...
class KashFlowPhpKit { 
    ...
    private function clean_dataset($data) {
   	...
   	public function GetCustomerByEmail($data) {
   		...
   		if(isset($response->soapBody->soapFault)) {
   			...
   			if($response->soapBody->GetCustomerByEmailResponse->Status=='OK') {
   				return $this->object_to_array($response->soapBody->GetCustomerByEmailResponse->GetCustomerByEmailResult);
   			} else {
   	...
   	public function GetCustomerVATNumber($data) {
   		...
   		if(isset($response->soapBody->soapFault)) {
   			...
   			if($response->soapBody->GetCustomerVATNumberResponse->Status=='OK') {
   				return $this->clean_dataset((array)$response->soapBody->GetCustomerVATNumberResponse->GetCustomerVATNumberResult);
   			} else {
   	...
   	public function GetCustomerCurrency($data) {
   		...
   		if(isset($response->soapBody->soapFault)) {
   			...
   			if($response->soapBody->GetCustomerCurrencyResponse->Status=='OK') {
   				return $this->clean_dataset((array)$response->soapBody->GetCustomerCurrencyResponse->GetCustomerCurrencyResult);
   			} else {
   	...
   	public function InsertInvoicePayment($data) {
   		...
   		if(isset($response->soapBody->soapFault)) {
   			...
   			if($response->soapBody->InsertInvoicePaymentResponse->Status=='OK') {
   				return $this->clean_dataset($this->object_to_array($response->soapBody->InsertInvoicePaymentResponse->InsertInvoicePaymentResult));
   			} else {
   	...
   	public function DeleteInvoicePayment($data) {
   		$xml 		= '<InvoicePaymentNumber>'. (int)$data['InvoicePaymentNumber'] .'</InvoicePaymentNumber>';
   	...
   	public function GetDigitaCSVFile($data) {
   		...
   		if(isset($response->soapBody->soapFault)) {
   			...
   			if($response->soapBody->GetDigitaCSVFileResponse->Status=='OK') {
   				return $this->clean_dataset((array)$response->soapBody->GetDigitaCSVFileResponse->GetDigitaCSVFileResult);
   			} else {
   	...
   	public function GetAccountOverview() {
   		...
   		if(isset($response->soapBody->soapFault)) {
   			...
   			if($response->soapBody->GetAccountOverviewResponse->Status=='OK') {
   				return $this->object_to_array($response->soapBody->GetAccountOverviewResponse->GetAccountOverviewResult);
   			} else {
   	...
   	public function GetSubProducts($data) {
   		...
   		if(isset($response->soapBody->soapFault)) {
   			...
   			if($response->soapBody->GetSubProductsResponse->Status=='OK') {
   				return $this->clean_dataset($this->object_to_array($response->soapBody->GetSubProductsResponse->GetSubProductsResult));
   			} else {
